...
function App() {
  ...
  // ----------------------------------------------------------------
  return (
    <div className={`vsqb-shell flex flex-col font-sans ${theme === 'dark' ? 'vsqb-theme-dark' : 'vsqb-theme-light'}`}>
        <header className="vsqb-header flex-shrink-0 z-10">
            <div className="flex items-center gap-4">
                <button onClick={() => setShowLeftPanel(!showLeftPanel)} className="p-2 rounded-lg lg:hidden transition-colors text-slate-300 hover:bg-slate-800 hover:text-white">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-bold leading-tight">VisualSQL Builder</h1>
                        <div className="flex items-center gap-1.5">
                            <div className="w-2 h-2 rounded-full bg-green-500"></div>
                            <span className="text-xs font-medium text-blue-100">{credentials.database}</span>
                        </div>
                    </div>
                </div>
            </div>
             ...
             <div className="flex items-center gap-3">
                ...
                <button onClick={runTour} className="vsqb-header-button vsqb-navy-button" title="Start Tour">
                    <HelpCircle size={18} />
                ...
                <button
                    ...
                    className="vsqb-theme-toggle"
                    aria-label="Toggle theme"
                >
                    {theme === 'dark' ? <Sun size={18} /> : <Moon size={18} />}
                </button>
                
                <button id="ai-assistant-btn" onClick={() => setShowAISidebar(true)} className="vsqb-header-button vsqb-navy-button" title="AI Assistant">
                    <Bot size={18} />
                ...
                <button 
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all border border-red-500/40 bg-red-500/10 text-red-300 hover:bg-red-500/20"
                >
                    <LogOut size={16}/> 
        ...
        <main className="flex-grow flex overflow-hidden relative">
            <PanelGroup direction="horizontal" className="flex-1">
                {showLeftPanel && (
                    <>
                        <Panel defaultSize={20} minSize={15} maxSize={30} className="!overflow-y-auto vsqb-panel-left">
                ...
                <Panel className="flex flex-col">
                    <PanelGroup direction="vertical">
                        <Panel defaultSize={55} minSize={20} className="p-4 vsqb-panel-center overflow-auto">
